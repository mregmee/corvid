...
var displayName         = "QuickQuote"; // The name displayed to the user (don't include the version)
var version             = "0.8.1";
var name                = "quickquote"; // The leafname of the JAR file (without the .jar part)
...
var locales             = new Array( "de-DE", "en-US", "es-AR", "es-ES", "fr-FR", "it-IT", "nl-NL", "pl-PL" );
